...
public class TestRabinKarp {
	...
	public void testKMPEmpty() {		
		Result result = RabinKarp.search ("aaa", "abcdexxxunbexxxke");
	...
	@Test
	public void testKMPEmpty2() {		
		Result result = RabinKarp.search ("aaa", "");
		
		System.out.println();
		System.out.print("Real empty text: Size: " + result.count + "; Indices: ");
		for(Integer i : result.resultIndices)
			System.out.print(i+"; ");
		System.out.println();
	...
	public void testKMPLong() {
		Result result = RabinKarp.search ("is", "Compares two strings lexicographically. The comparison is based on the Unicode value of each character in the strings. The character sequence represented by this String object is compared lexicographically to the character sequence represented by the argument string. The result is a negative integer if this String object lexicographically precedes the argument string. The result is a positive integer if this String object lexicographically follows the argument string. The result is zero if the strings are equal; compareTo returns 0 exactly when the equals(Object) method would return true.");
	...
	public void testKMPVeryLong() {
		Result result = RabinKarp.search ("Lorem ipsum dolor sit amet", "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod "
