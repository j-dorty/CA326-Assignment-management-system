...
public class TestBoyerMoore {
	...
	@Test
	public void testBoyerMooreEmpty() {
		Result result = BoyerMoore.search ("aba", "abcdexxxunbexxxke");
	...
	@Test
	public void testBoyerMooreShort() {
		Result result = BoyerMoore.search ("xxx", "abcdexxxunbxxxxke");
		...
		assertTrue(result.count > 0);
		assertEquals(Integer.valueOf(3), result.count);
	...
	@Test
	public void testBoyerMooreSpecial() {
		Result result = BoyerMoore.search ("xxx", "xxxxxA");
	...
	@Test
	public void testBoyerMooreLong() {
		Result result = BoyerMoore.search ("is", "Compares two strings lexicographically. The comparison is based on the Unicode value of each character in the strings. The character sequence represented by this String object is compared lexicographically to the character sequence represented by the argument string. The result is a negative integer if this String object lexicographically precedes the argument string. The result is a positive integer if this String object lexicographically follows the argument string. The result is zero if the strings are equal; compareTo returns 0 exactly when the equals(Object) method would return true.");
		...
		assertTrue(result.count > 0);
		assertEquals(Integer.valueOf(9), result.count);
	...
	@Test
	public void testBoyerMooreVeryLong() {
		Result result = BoyerMoore.search ("Lorem ipsum dolor sit amet", "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod "
		...
		assertTrue(result.count > 0);
		assertEquals(Integer.valueOf(52), result.count);
